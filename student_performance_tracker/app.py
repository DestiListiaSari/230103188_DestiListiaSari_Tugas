# app.py
# File utama untuk Student Performance Tracker
# VERSI DENGAN BONUS TANTANGAN (FILTER & HTML)

import csv
import os

# Impor semua kelas dan fungsi yang kita butuhkan dari paket 'tracker'
from tracker import (
    Mahasiswa, 
    RekapKelas,
...
try:
    ...
    print("Install 'rich' (pip install rich) untuk tampilan tabel yang lebih baik.")
    Table = None
...
# Fungsi untuk menyimpan laporan HTML
...
def menu():
    ...
    r = RekapKelas() # Objek rekap utama
